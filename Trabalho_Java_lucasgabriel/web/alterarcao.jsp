                    ...
                    <form action="CadastrarCao" method="POST" class="p-5 needs-validation" novalidate>                                
                        ...
                        <div class="form-row">
                            <div class="col-md-6  mb-2">
                                ...
                                <input type="text" ${cao.nome_cao} minlength="6" name="nome_cao"  class="form-control" placeholder="Digite o nome do animal" required />
                            </div>
                            <div class="col-md-6  mb-2" >
                                <label for="idade_cao">Idade do Cão</label>
                                <input type="number" value="${cao.idade_cao}" minlength="8" name="idade_cao" placeholder="Digite a idade do animal" class="form-control" required/>
                        ...
                        <div class="form-row">
                            <div class="col-md-6 mb-2">
                                ...
                                <input type="number" value="${cao.id_cao}" step="0.01" name="peso_cao" placeholder="Digite o peso do animal" class="form-control" required/>
                            </div>
                            <div class="col-md-6  mb-2" >
                                ...
                                <select id="desc_tipo" name="id_raca" class="form-control">
                                    ...
                                    <option  selected="<%if(racacao.getId_raca()== raca.getId_raca()){ out.write("selected"); }  %> value="<%=raca.getId_raca()%>"><%=raca.getDesc_raca()%></option>
                                    <%}%>
                                </select>
                            </div>
