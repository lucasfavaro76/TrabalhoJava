...
public class CadastrarRaca extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            String raca_cao = request.getParameter("raca_cao");          

            String mensagem = null;

            RacaCao raca = new RacaCao();
            raca.setDesc_raca(raca_cao);
                      

            try {
                GenericDAO dao = new RacaCaoDAOImpl();
                if (dao.cadastrar(raca)) {
                    mensagem = "Raça cadastrado com sucesso";
                } else {
                    mensagem = "Problemas ao cadastrar raça";
                }
